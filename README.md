# PROJECT-3-UEMK-MASK-DETECTION-SYSTEM-WITH-COVID-UPDATES :star_struck: :mask: :computer: :open_file_folder: :pencil2: :notebook:
...
The main goal of our project is to implement ‘MASK DETECTION SYSTEM’ and ‘COVID UPDATES’ using deep learning concept. For making it user friendly my target is to build a ‘GUI’ with buttons integrated on it for using the system. For the live detection idea, I have to detect faces and also detect the accuracy or wearing or not wearing mask. Based on that I have to produce a decision as the output. I also have to work on image data for training model. For Covid Updates section I have to make a GUI and pop notification as per user’s chosen country and type of covid case. I have to also keep an option to download databases of covid cases. To make correct result and get correct and updated data is also our concern.
...
<a href="images/arc.PNG"><img src="images/arc.PNG" width="400" height= "300"></a> <a href="images/table.PNG"><img src="images/table.PNG" width="400" height= "300"></a>
